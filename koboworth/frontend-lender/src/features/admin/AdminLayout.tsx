...
import { Users, AlertTriangle, ScrollText, Network, ActivitySquare, LogOut, MessageSquare } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-slate-50 text-slate-900 font-sans">
      <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col">
        <div className="p-6 border-b border-slate-800 flex flex-col items-center">
          ...
          <span className="text-sm font-black text-red-500 uppercase tracking-widest drop-shadow-sm">IT Specialist</span>
        </div>
        <nav className="flex-1 p-4 space-y-1">
          {navItem('/admin/collectors', 'Collectors', Users)}
          {navItem('/admin/disputes', 'Disputes', AlertTriangle)}
          {navItem('/admin/complaints', 'Support Tickets', MessageSquare)}
