      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-md space-y-6 bg-white p-10 rounded-2xl shadow-xl">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Collector Registration</h2>
            <p className="mt-2 text-sm text-gray-600">Join Koboworth as an Ajo Collector</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="mt-6 space-y-4">
            ...
            <div className="text-center mt-4">
              ...
              <Link to="/collector-login" className="text-sm font-semibold text-blue-600 hover:text-blue-500 transition-colors">
                Sign in here
              </Link>
            </div>
